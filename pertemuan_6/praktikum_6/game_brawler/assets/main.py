...
ICON_PATH = "images/icons/logo.gif" # Ganti dengan path ikon Anda
try:
    # Memuat gambar ikon
    ...
    print(f"Ikon jendela berhasil diganti dengan: {ICON_PATH}")
    
except pygame.error as e:
    # Ini akan muncul jika file ikon tidak ditemukan atau rusak
    print(f"❌ Gagal memuat ikon jendela dari {ICON_PATH}. Error: {e}")
